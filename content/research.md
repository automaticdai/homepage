...
{{< project-card img="/img/rr-engine.png" headline="(2023 - 2028) Co-I, University of York | Funded by Innovate UK, £2,270,617 (out of £22.4m)" >}}
...
[**Read more about MOCHA →**](https://www.cs.york.ac.uk/rts/mocha/)
{{< /project-card >}}

### ➤ DEIS: Dependability Engineering Innovation for CPS

{{< project-card img="/img/ode.png" headline="(2018 - 2019) RA, University of York | Funded by EU Horizon 2020, £313,415" >}}
...
Key outcomes of DEIS include contributions to the OMG [System Assurance Case Metamodel (SACM)](https://www.omg.org/spec/SACM/2.2/About-SACM) standard and the Assurance Case Modelling Environment (ACME) tool.

[**Read more about DEIS →**](https://cordis.europa.eu/project/id/732242)
{{< /project-card >}}
