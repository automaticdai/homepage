...
## 2025
- {{<tag-journal>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
...
## 2024
- {{<tag-chapter>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    {{< bibtitle "Special edition on resource partitioning for modern multicore systems" >}}
    {{< bibauthors "Ian Gray, Xiaotian Dai" >}}
    **(*RTSJ*)** Real-Time Systems Journal <br>
    [\[Chapter\]](https://link.springer.com/article/10.1007/s11241-024-09428-2)

## 2023
- {{<tag-chapter>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    {{< bibtitle "Evolvement of Scheduling Theories for Autonomous Vehicles" >}}
    {{< bibauthors "Wanli Chang, Nan Chen, Shuai Zhao, Xiaotian Dai" >}}
    Springer. 2023. <br>
    [\[Chapter\]](https://link.springer.com/chapter/10.1007/978-3-031-28016-0_2)

- {{<tag-journal>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    {{< bibtitle "NPRC-I/O: A NoC-based Real-Time I/O System with Reduced Contention and Enhanced Predictability" >}}
    {{< bibauthors "Zhe Jiang, Xiaotian Dai, Ran Wei, Ian Gray, Zonghua Gu, Qingling Zhao, Shuai Zhao" >}}
...
- {{<tag-journal>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Jie Zou, Xiaotian Dai, John A McDermid" >}}
    **(*TCAD*)** IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems. 2023. <br>
    [\[Paper\]](https://ieeexplore.ieee.org/document/10310275)

- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    {{< bibtitle "Cache-Aware Allocation of Parallel Jobs on Multi-cores based on Learned Recency" >}}
    {{< bibauthors "Shuai Zhao, Xiaotian Dai, Benjamin Lesage, Iain Bate" >}}
...
- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Benjamin Lesage, Xiaotian Dai, Shuai Zhao, Iain Bate" >}}
    **(*RTNS'23*)** International Conference on Real-Time Networks and Systems. 2023. <br>
    [\[Paper\]](https://dl.acm.org/doi/abs/10.1145/3575757.3593654)

- {{<tag-workshop>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    {{< bibtitle "Many-Core Real-Time Network-on-Chip I/O Systems for Reducing Contention and Enhancing Predictability" >}}
    {{< bibauthors "Zhe Jiang, Xiaotian Dai, Shuai Zhao, Ran Wei, Ian Gray" >}}
...
- {{<tag-workshop>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Jie Zou, Xiaotian Dai, John McDermid" >}}
    **(*RAGE'23*)** Real-time And intelliGent Edge computing workshop (*RAGE 2023 @ CPS-IoT Week*). 2023. <br>
...
- {{<tag-workshop>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Zhe Jiang, Xiaotian Dai, Alan Burns, Neil Audsley, Zonghua Gu, Ian Gray" >}}
...
- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Xiaotian Dai, Shuai Zhao, Benjamin Lesage, Iain Bate" >}}
...
- {{<tag-journal>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Zou Jie, Xiaotian Dai, John McDermid" >}}
...
- {{<tag-journal>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Shuai Zhao, Xiaotian Dai, Iain Bate" >}}
...
- {{<tag-conference>}} {{<topic>}}Control Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Seyed A. Tafrishi, Xiaotian Dai, Yasuhisa Hirata, Alan Burns" >}}
...
- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Zhe Jiang, Xiaotian Dai, Neil Audsley" >}}
...
- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Xiaotian Dai, Shuai Zhao, Iain Bate, Alan Burns, Xing Guo, Wanli Chang" >}}
...
- {{<tag-journal>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Zhe Jiang, Xiaotian Dai, Pan Dong, Ran Wei, Dawei Yang, Neil Audsley, Nan Guan" >}}
...
- {{<tag-journal>}} {{<topic>}}Robotics{{</topic>}} {{<topic>}}Vision{{</topic>}} <br>
    {{< bibtitle "Line-Circle-Square (LCS): A Multilayered Geometric Filter for Edge-Based Detection" >}}
    {{< bibauthors "Seyed A. Tafrishi, Xiaotian Dai, Vahid E. Kandjani" >}}
...
- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Shuai Zhao, Xiaotian Dai, Iain Bate, Alan Burns, Wanli Chang" >}}
...
- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Xiaotian Dai, Shuai Zhao, Yu Jiang, Xun Jiao, Xiaobo Sharon Hu, Wanli Chang" >}}
...
- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Shuai Zhao, Zhe Jiang, Xiaotian Dai, Iain Bate, Ibrahim Habli, Wanli Chang" >}}
...
- {{<tag-conference>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Dawei Yang, Xinlei Li, Xiaotian Dai, Rui Zhang, Lizhe Qi, Wenqiang Zhang, Zhe Jiang" >}}
...
- {{<tag-journal>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Xiaotian Dai, Alan Burns" >}}
...
- {{<tag-journal>}} {{<topic>}}Real-Time Systems{{</topic>}} <br>
    ...
    {{< bibauthors "Xiaotian Dai, Wanli Chang, Shuai Zhao, Alan Burns" >}}
...
- {{<tag-journal>}} {{<topic>}}Safety Engineering{{</topic>}} <br>
    {{< bibtitle "Model Based System Assurance Using the Structured Assurance Case Metamodel" >}}
    {{< bibauthors "Ran Wei, Tim Kelly, Xiaotian Dai, Shuai Zhao, Richard Hawkins" >}}
...
- {{<tag-thesis>}} {{<topic>}}Robotics{{</topic>}} <br>
